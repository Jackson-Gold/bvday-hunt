 ...
 *
 *  Each stop (keyed by its number, 1–6) has four pieces of text:
 *
 ...
 *    hint            — a gentle nudge; appears after 3 wrong password attempts.
...
window.HUNT_CLUES = {
  ...
  2: {
    clue:
      ...
      "Look for you next clue on a wooden doorframe a few buildings south (the way you're coming) from this place.",
  ...
  3: {
    clue:
      "Now find a quiet place full of stories and crystals, where incense " +
      "drifts and the shelves hum with a little magic. Look for the purple " +
      "stone and the lucky little creature hiding there.",
    locationDetail: "PLACEHOLDER — exact address / what she'll see when she's there.",
    hint: "PLACEHOLDER — optional gentle nudge.",
    reveal: "PLACEHOLDER — what she discovers here, and a hint toward the next stop."
  },
